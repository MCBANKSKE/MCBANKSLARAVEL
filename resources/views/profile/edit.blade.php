...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">Manage your profile information and privacy settings</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-2xl font-bold {{ $this->completionColor }} text-white px-3 py-1 rounded-full">
                    {{ $this->completion_percentage }}%
                </span>
            </div>
            <div class="w-full bg-gray-200 rounded-full h-3 mb-2">
                <div class="h-3 rounded-full transition-all duration-300 {{ $this->completionColor }}" 
                     style="width: {{ $this->completion_percentage }}%"></div>
            </div>
            <p class="text-sm text-gray-600">{{ $this->completionMessage }}</p>
        </div>
